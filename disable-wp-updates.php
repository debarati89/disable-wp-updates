...
Author URI:  https://w3.ibm.com/bluepages/profile.html?uid=AVKFD8744
*/

define("IBMWPUVERSION", "1.0");

class IBM_Disable_WordPress_Updates {
...
if ( class_exists('IBM_Disable_WordPress_Updates') ) {
	$IBM_Disable_WordPress_Updates = new IBM_Disable_WordPress_Updates();
}
?>